...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var WHEEL_ZOOM_DISABLED_TIMEOUT = 0; //??
        var ViewOnLoad = {
            UNKNOWN: -1,
            PREVIOUS: 0,
            INITIAL: 1
        ...
        function webViewerWheel(evt) { //evt.preventDefault();
            var pdfViewer = PDFViewerApplication.pdfViewer,
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var PDFPageView =
            ...
            function() {
                ...
                _createClass(PDFPageView, [{ //MAIN changehere
                    key: "setPdfPage",
                    value: function setPdfPage(pdfPage) {
                        this.pdfPage = pdfPage;
                        this.pdfPageRotate = pdfPage.rotate;
                    ...
                    value: function paintOnCanvas(canvasWrapper) {
                        ...
                        console.log((0, _ui_utils.approximateFraction));
                        console.log(sfx);
                        console.log(sfy);

                        // viewport.scale = my_ratio;

                        canvas.width = my_ratio * (0, _ui_utils.roundToDivide)(viewport.width * outputScale.sx, sfx[0]);
                        canvas.height = my_ratio * (0, _ui_utils.roundToDivide)(viewport.height * outputScale.sy, sfy[0]);

                        console.log(' _ui_utils.approximateFraction');
                        ...
                        ctx.setTransform(my_ratio, 0, 0, my_ratio, 0, 0);
                        // ctx.transform(my_ratio, 0, 0, my_ratio, 0, 0);
                        ...
                        console.log("style.width is " + canvas.style.width + " width is " + canvas.width);
                        console.log("style.height is " + canvas.style.height + " height is " + canvas.height);
                        var styleRatio = (canvas.style.height.substring(0, canvas.style.height.length - 2) / canvas.style.width.substring(0, canvas.style.width.length - 2));

                        console.log("style ratio is " + styleRatio);
                        console.log("ratio is " + (canvas.height / canvas.width));
                        ...
                        // var transform = [my_ratio, 0, 0, my_ratio, 0, 0];
                        console.log(transform);
    ...
    (function(module, exports, __webpack_require__) {
        ...
        function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size) {
            ...
            ctx.restore();
            return pdfDocument.getPage(pageNumber).then(function(pdfPage) { //PRINT
                var renderContext = {
                    canvasContext: ctx,
